...
path = r'C:\Users\Muku\OneDrive - Aalborg Universitet\P4 - GrisProjekt\Training data\Videos'
...
for category in category_names:
    ...
    for depth_path in listof_depth:
        ...
        while True:
            ...
            imf.resize_image(frame_bgr, 'color image', 0.5)
                ...
                if hierarchy is not None:
                    ...
                    for cnt, hrc in zip(contours, hierarchy):
                        if cv2.contourArea(cnt) >= 50:
                            ...
                            if probability > best_fit[1]:
                                best_fit = [detected, probability, cnt]
                print(f'results {best_fit[0]}, with a {best_fit[1]} chance')
                cv2.drawContours(draw_frame, [best_fit[2]], 0, (0, 0, 255), 2)
                print(f'Is this correct?, yes = s, no = q')
                while True:
                    ...
                    if key == ord('s'):
                        ...
                        cv2.drawContours(save_img, [best_fit[2]], 0, 255, -1)
