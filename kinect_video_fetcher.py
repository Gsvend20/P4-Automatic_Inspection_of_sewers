...
class KinectFetcher:
    def __init__(self, kinect_desired_fps):
        # Make object for collecting frames from kinect camera
        self._kinect_object = PyKinectRuntime.PyKinectRuntime(PyKinectV2.FrameSourceTypes_Color |
    ...
    def fetch_frames(self):
        while True:
            if self._kinect_object.has_new_color_frame() and self._kinect_object.has_new_depth_frame():
                ...
                if elapsed_time > self._time_index / self.kinect_fps_limit:
                    ...
                    color_frame = self._kinect_object.get_last_color_frame()
                    depth_frame = self._kinect_object.get_last_depth_frame()
                    ir_frame = self._kinect_object.get_last_infrared_frame()
    ...
    def show_frames(self):
        # TODO: Add scaling to depth data for visualisation
        ...
        cv2.imshow('KINECT depth channel', self.depth_frame)
